"""
Solving: https://adventofcode.com/2022/day/11#part2
"""
...
#     If false: throw to monkey 1""".splitlines()
    ...
    least_common_multiple = reduce(
        operator.mul, [monkey.test_condition for monkey in monkeys]
    )

    for _ in range(10000):
        for monkey in monkeys:
            monkey.do_opeartion(monkeys, least_common_multiple)
    ...
    logger.info(f"Part2: {monkey_business=}")
